...
switch ($action) {
    ...
    case "check_info":
      ...
      $address_is_valid = !empty($street_address) && !empty($city_address) && !empty($state_address)
         && !empty($zip_code_address);
      ...
      <form class="form-horizontal" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <?php if (!empty($address_error)): ?>
          <div class="alert alert-danger">
            <strong><?php echo htmlspecialchars($address_error); ?></strong>
          </div>
        <?php endif; ?>

        <div class="form-group row">
          <div class="col-md-6">
            <input type="text" class="form-control" id="address" name="street_address" placeholder="Address" value="<?php echo htmlspecialchars($address_row["street"]); ?>">
          </div>
        </div>

        <div class="form-group row">
          <div class="col-md-2">
            <input type="text" class="form-control" name="city_address" id="city" placeholder="City" value="<?php echo htmlspecialchars($address_row["city"]); ?>">
          </div>
          <div class="col-md-2">
            <input type="text" class="form-control" name="state_address" id="state" placeholder="State" value="<?php echo htmlspecialchars($address_row["state"]); ?>">
          </div>
          <div class="col-md-2">
            <input type="text" class="form-control" name="zip_code_address" id="zipcode" placeholder="Zip Code" value="<?php echo htmlspecialchars($address_row["zipcode"]); ?>">
          </div>
        </div>
        ...
        <div class="form-group"> 
          ...
          <fieldset>
           ...
           <?php if (!empty($card_error)): ?>
            <div class="alert alert-danger">
              <strong><?php echo htmlspecialchars($card_error); ?></strong>
            </div>
          <?php endif; ?>
          <div class="form-group row">
            <div class="col-md-6">
