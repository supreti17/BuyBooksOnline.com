...
(1, 'John', 'Doe', 'john@example.com', '2017-03-05 06:02:30'),
(2, 'Mary', 'Doe', 'mary@example.com', '2017-03-05 06:02:38'),
(3, 'Julie', 'Dooley', 'julie@example.com', '2017-03-05 06:02:30');
...
--
ALTER TABLE `UserAddress`
ADD CONSTRAINT `useraddress_address_id_fk` FOREIGN KEY (`address_id`) REFERENCES `Address` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `useraddress_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `Users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
