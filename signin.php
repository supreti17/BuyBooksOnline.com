...
?>
  ...
  <?php require('php/navbar.php'); ?>
    ...
    <div class="container">
      ...
      <form class="form-signin" id="signup_form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <button class="btn btn-lg btn-primary btn-block btn-success" type="submit" name="action" value="sign_up_form">Sign Up</button>
